...
const countriesFlags = [
	...countriesData.map((country) => {
		return [country.code, { code: country.code, image: country.image, name: country.name, emoji: country.emoji }]
	}),
]

export const flagsObject = Object.fromEntries(countriesFlags)
